...
| **MySpec** | [myspec.dev](https://myspec.dev) | Free | TS | Spec-Driven Development (SDD) platform generating 4-file context bundles (`constitution`, `requirements`, `solution`, `tasks`) via MCP for Cursor and Claude Code |
