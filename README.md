...
| **SearchLink Lite** | [GlobalMatchHub/searchlink-lite](https://github.com/GlobalMatchHub/searchlink-lite) | New | TS | Read-only Google Search Console reporting: clicks, queries, pages, index status, sitemaps |
